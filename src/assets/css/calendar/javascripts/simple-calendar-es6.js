...
class SimpleCalendar {
  ...
  create() {
    ...
    for (var i = 0; i < 35; i++) {
      // days.innerHTML = days.innerHTML + '<div style="background-color:'+ this.randomColor() +'"" class="sc-item"><div class="day"></div><div class="lunar-day"></div></div>';
      
      days.innerHTML = days.innerHTML + '<div style="background-color:#4fc1a7" class="sc-item"><div class="day"></div><div class="lunar-day"></div></div>';
    }
    //添加下拉框数据
  ...
  randomColor(){
      return 'rgb(' + this.randomVal(255) + ',' + this.randomVal(255) + ',' + this.randomVal(255) + ')';
  }
